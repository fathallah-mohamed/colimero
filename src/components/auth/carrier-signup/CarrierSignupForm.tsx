...
export default function CarrierSignupForm({ onSuccess }: CarrierSignupFormProps) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleRegistration)} className="space-y-4 md:space-y-6">
        <FormSections form={form} />

        <div className="mt-4 md:mt-6 text-center">
          <Button 
            type="submit" 
            className="w-full max-w-md button-gradient text-white py-4 md:py-6 text-base md:text-lg font-semibold"
